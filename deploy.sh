#!/bin/bash
# ==============================================================================
# VIRGOZKI PANEL • MANUAL REGION SELECT ONLY + GPRPC SUPPORT
# ALL REGIONS WITH COUNTRY • XHTTP FIXED • HTTPUPGRADE INTACT • GPRPC ADDED
...
echo -e "  ${GREEN}✅ MANUAL SELECT ONLY • ALL REGIONS • XHTTP FIXED • GPRPC ADDED${RESET}"
echo ""
...
# ✅ EXISTING LINKS – WALANG PINAGBAGO
...
# ✅ BAGONG GPRPC LINKS – TAMA ANG TLS, ALPN, HEADER TYPE
VLESS_GRPC="vless://${VMESS_UUID}@${CLEAN_HOST}:443?encryption=none&type=grpc&path=/vless-grpc&host=${CLEAN_HOST}&security=tls&sni=${CLEAN_HOST}&alpn=h2,http/1.1&headerType=multi#VLESS-GRPC"
VMESS_GRPC_JSON='{"v":"2","ps":"VMESS-GRPC-virgozki","add":"'"${CLEAN_HOST}"'","port":"443","id":"'"${VMESS_UUID}"'","aid":"0","scy":"auto","net":"grpc","type":"multi","host":"'"${CLEAN_HOST}"'","path":"/vmess-grpc","tls":"tls","sni":"'"${CLEAN_HOST}"'","fp":"chrome","alpn":"h2,http/1.1"}'
VMESS_GRPC_B64=$(echo -n "$VMESS_GRPC_JSON" | base64 -w0)
TROJAN_GRPC="trojan://virgozki@${CLEAN_HOST}:443?type=grpc&path=/trojan-grpc&host=${CLEAN_HOST}&security=tls&sni=${CLEAN_HOST}&alpn=h2,http/1.1&headerType=multi#TROJAN-GRPC"
SS_GRPC="ss://${SS_B64}@${CLEAN_HOST}:443?type=grpc&path=/ss-grpc&host=${CLEAN_HOST}&security=tls&sni=${CLEAN_HOST}&alpn=h2,http/1.1&headerType=multi#SHADOWSOCKS-GRPC"
...
echo -e "  ${YELLOW}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${RESET}"
echo -e "  ${CYAN}            ALL PROTOCOLS (WS + HU + XHTTP + GPRPC)${RESET}"
echo -e "  ${YELLOW}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${RESET}"
echo ""
echo -e "  ${GREEN}✓ VLESS   ${CYAN}WS: /vless-virgozki    ${GREEN}HU: /vless-virgozki-hu    ${CYAN}XHTTP: /vless-virgozki-xhttp    ${GREEN}GRPC: /vless-grpc${RESET}"
echo -e "  ${GREEN}✓ VMESS   ${CYAN}WS: /vmess-virgozki    ${GREEN}HU: /vmess-virgozki-hu    ${CYAN}XHTTP: /vmess-virgozki-xhttp    ${GREEN}GRPC: /vmess-grpc${RESET}"
echo -e "  ${GREEN}✓ TROJAN  ${CYAN}WS: /virgozki          ${GREEN}HU: /virgozki-hu          ${CYAN}XHTTP: /virgozki-xhttp          ${GREEN}GRPC: /trojan-grpc${RESET}"
echo -e "  ${GREEN}✓ SHADOWSOCKS ${CYAN}WS: /ss-virgozki    ${GREEN}HU: /ss-virgozki-hu    ${CYAN}XHTTP: /ss-virgozki-xhttp    ${GREEN}GRPC: /ss-grpc${RESET}"
echo ""
echo -e "  ${CYAN}✓ SNI: ${GREEN}${CLEAN_HOST}${RESET}   ${CYAN}✓ ALPN: ${GREEN}h2,http/1.1${RESET}   ${CYAN}✓ HEADER: ${GREEN}multi${RESET}   ${CYAN}✓ FINGERPRINT: ${GREEN}chrome${RESET}"
echo ""
...
echo -e "  ${CYAN}SHADOWSOCKS GRPC:   ${GREEN}${SS_GRPC}${RESET}"
echo -e "  ${YELLOW}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${RESET}"
...
# ✅ CLEANUP
rm -f build.log deploy.log
echo -e "\n  ${GREEN}✅ SCRIPT FINISHED • GPRPC ADDED • NO EXISTING FILES BROKEN${RESET}"
